  ...
  return (
    ...
    >
      ...
      <img
        ...
        className="absolute right-0 -top-2 md:-top-6 w-32 sm:w-36 md:w-40 lg:w-48 xl:w-60"
      ...
      <img
        ...
        className="absolute -z-10 w-32 sm:w-36 md:w-40 lg:w-60 xl:w-80 right-0 bottom-[60%] translate-y-[30%] lg:left-1/2 lg:-translate-x-[80%] lg:right-auto lg:-bottom-40 lg:translate-y-0"
      ...
      <img
        ...
        className="absolute left-0 top-20 w-28 sm:w-32 md:w-32 lg:w-32 xl:w-40"
